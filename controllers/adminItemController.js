...
const createItem = async (req, res) => {
  try {
    ...
    // Create item
    const newItem = await Item.create({ name, description, price, category, restaurant: restaurantId, image: imageUrl, });
...
const getAllItems = async (req, res) => {
  try {
    const items = await Item.find().populate('restaurant', 'name location');
...
const deleteItem = async (req, res) => {
  try {
    ...
    // Remove item from the restaurant’s menu as well
